...
public class WarehouseArea extends Location {
	Scanner in = new Scanner(System.in);
	Random rand = new Random();
	MafiaMember mafiamember = new MafiaMember();
	Character player = new Character();

	public WarehouseArea(String t, Character c) {
		super(t,c);
	}
	
	public void survive(){
		//Game variables
		String[] enemies = { "Mafiamember" };
		int maxEnemyHealth = mafiamember.getHpMax();
		int enemyAttackDamage = mafiamember.getDmgOut();
		...
		System.out.println("Oh no, original mobster has spotted you... he carries a battleknife, you should be on extra-alert");
