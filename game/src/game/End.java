...
public class End {
	...
	public static void endingCR() throws Exception {
		
		
		int x = 40; //text speed in milliseconds
	
		System.out.println(" ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~");
		String text1 = "      You enter the control room you see an control panel with dozens of flashng lights on it."; 
		for (int i = 0; i < text1.length(); i++) {
			System.out.print(text1.charAt(i));
			Thread.sleep(x);
		}
		...
		String text2 = "         You start randomly hitting different buttons on the control panel and before long "; 
		for (int i = 0; i < text2.length(); i++) {
			System.out.print(text2.charAt(i));
			Thread.sleep(x);
		}
		...
		String text5 = "          As you are preparing yourself for the impact Death appears before you again:"; 
		for (int i = 0; i < text5.length(); i++) {
			System.out.print(text5.charAt(i));
			Thread.sleep(x);
		}
